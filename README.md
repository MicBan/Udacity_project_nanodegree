...
There should be no necessary libraries to run the code here beyond the Anaconda distribution of Python.  The code should run with no issues using Python versions 3.*. For completness, list libraries used in the project is listed below:
- sklearn
- keras
- numpy
- pandas
...
It is highly recommended to run the Jupyter Notebook only when you have access to GPU due to performance issues should you run optimisation on your CPU.
...
The result of this project are presented on a blog post (link). Additionally one can read the provided 'dog_app.html' to see all the steps and results I took working on this project.
